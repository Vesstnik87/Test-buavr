...
urlpatterns = [
	...
	path('remonti/', views.RemontUchastki.as_view(), name='remonti'),
	path('remonti/<slug:slug>/', views.RemontDetail.as_view(), name='remont_detail'),
	path('remonti/<slug:slug>/<slug:number>/', views.TrubaDetail.as_view(), name='remont_truba'),
	path('remonti/<slug:slug>/<int:number>/update/', views.TrubaUpdate.as_view(), name='remont_truba_update'),
